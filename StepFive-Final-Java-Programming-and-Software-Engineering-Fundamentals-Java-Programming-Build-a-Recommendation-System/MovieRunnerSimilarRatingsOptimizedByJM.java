 ...
 *
 *  Description:  -------------------STEP FOUR Optimized by JIAN MA--------
 ...
 *
 *  * IMPORTANT NOTICE:
 *      * Weighted average algorithm optimized by JIAN MA
...
public class MovieRunnerSimilarRatingsOptimizedByJM {
    public void printSimilarRatings() {
        FourthRatingsOptimizedByJM tr = new FourthRatingsOptimizedByJM();//do i need put filename here?
    ...
    public static void main(String[] args) {
        MovieRunnerSimilarRatingsOptimizedByJM mra = new MovieRunnerSimilarRatingsOptimizedByJM();
        System.out.println("----------Weighted average algorithm optimized by JIAN MA DECEMBER 14 2019------------");
        System.out.println("DUKE:   \"sum of (similar rating(i) *rating of the movie(i))/count of the raters\"");
        System.out.println("JIAN MA: \"sum of (similar rating(i) *rating of the movie(i))/ sum of the similar rating(i)\", will achieve better results.");
